...
builder.Services.AddControllers(options => options.Filters.Add<ValidationFilter>())
                .AddFluentValidation(configuration => configuration
                    ...
                    .RegisterValidatorsFromAssemblyContaining<CreateBrandCommandValidator>()
                    .RegisterValidatorsFromAssemblyContaining<DeleteBrandCommandValidator>()
                    .RegisterValidatorsFromAssemblyContaining<UpdateBrandCommandValidator>()
                    .RegisterValidatorsFromAssemblyContaining<GetByIdBrandQueryValidator>()
